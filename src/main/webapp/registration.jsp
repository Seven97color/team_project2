...
<body>
	...
	<br>
	<lebel for="customerkana">かな</lebel>
	<input type="text" id="customerkana" name="customer_kana"
		placeholder="やまだたろう" required>
	<br>
	<label for="zipcode">郵便番号</label>
	<input type="text" id="zipcode" name="zipcode" maxlength="7"
		pattern="\d{7}" placeholder="8120037" required>
	<br>
	...
	<input type="text" id="birthday" name="birthday" placeholder="19910105"
		required>
	<br>
	<label for="tel">電話番号</label>
	<input type="tel" id="tel" name="tel" pattern="[\d\-]{10,13}"
		maxlength="13" placeholder="09011112222" required>
	<br>
	<button type="submit">顧客登録確定</button>
	<button type="reset">クリア</button><br>
	<form action="menu.jsp" method="get">
	<button type="submit">メニュー画面へ</button></form>
